...
def cv_png(
    image_pickle, integration_pickle, file_name=None, res=600, show_integration=True
):
    ...
    plt.title("UC: {} ({}) \nMOS: {}".format(point_group, unit_cell, mosaicity))
    plt.savefig(file_name, dpi=res, format="png")
