...
class SingleImage(object):
    ...
    def generate_grid(self):
        ...
        if self.params.selection.select_only.flag_on:
            ...
            gs_block = []
            h_min = (
                self.params.grid_search.height_median
                - self.params.grid_search.height_range
            )
            h_max = (
                self.params.grid_search.height_median
                + self.params.grid_search.height_range
            ...
            a_min = (
                self.params.grid_search.area_median - self.params.grid_search.area_range
            )
            a_max = (
                self.params.grid_search.area_median + self.params.grid_search.area_range
            )
    ...
    def integrate(self, tag):
        ...
        if (
            self.triage == "rejected"
            or not self.prefilter
            or len(self.grid) == 0
            or self.final["final"] == None
        ):
            self.grid = []
