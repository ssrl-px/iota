...
class UIInitAll(InitGeneral):
    ...
    def initialize_info_object(self):
        ...
        self.info.__setattr__(
            "obj_list_file", os.path.join(self.tmp_base, "finished_objects.lst")
        )
        self.info.__setattr__(
            "finished_pickles_file", os.path.join(self.int_base, "finished_pickles.lst")
        )
        self.info.__setattr__(
            "cluster_info_file", os.path.join(self.int_base, "cluster_info.pickle")
        )
