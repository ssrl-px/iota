...
class Triage(object):
    ...
    def triage_image(self):
        ...
        if self.params.cctbx_ha14.image_triage.type == "grid_search":
            ...
            a_step = (
                a_max - a_min
            ) // self.params.cctbx_ha14.image_triage.grid_search.step_size
        ...
        # ... using spotfinding without grid search
            ...
            sf_params.distl.minimum_spot_area = (
                self.params.cctbx_ha14.grid_search.area_median
            )
            sf_params.distl.minimum_spot_height = (
                self.params.cctbx_ha14.grid_search.height_median
            )
...
class Processor(object):
    ...
    def __init__(
        ...
        if self.params.cctbx_ha14.target_unit_cell is not None:
            t_uc = [
                str(i) for i in self.params.cctbx_ha14.target_unit_cell.parameters()
            ]
