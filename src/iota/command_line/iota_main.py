...
class ProcWindow(wx.Frame):
    ...
    def onFinishedOneTask(self, e):
        ...
        if self.stage == "process":
            ...
            self.graph_tab.nsref_axes.scatter(
            ...
            self.graph_tab.nsref_axes.set_title(
                "Strong Reflections by Frame (I / sigI > {})"
            ...
            self.graph_tab.res_axes.scatter(
        ...
        if os.path.isfile(self.tmp_abort_file):
            ...
            self.sb.SetStatusText(
                "{} of {} images imported".format(
                    len(self.objects_in_progress), len(self.init.input_list)
                ),
                1,
            )
        elif self.stage == "gs_import":
            self.sb.SetStatusText(
                "{} of {} objects imported".format(
                    len(self.objects_in_progress), len(self.init.gs_img_objects)
                ),
                1,
            )
        elif self.stage == "process":
