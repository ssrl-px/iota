...
class ProcWindow(wx.Frame):
    ...
    def onTimer(self, e):
        ...
        if self.gparams.image_conversion.convert_only:
            ...
            processed_images = [
                i for i in self.objects_in_progress if i.status == "final"
            ]
            self.sb.SetStatusText(
...
class CCTBXOptions(wx.Dialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        ctr_length = (
            540
            - self.cctbx_btn_target.GetSize()[0]
            ...
            if self.params.advanced.integrate_with == "cctbx":
                if self.params.cctbx.target == None:
                    ...
                    if write_def.ShowModal() == wx.ID_YES:
                        inp.write_defaults(
                            self.params.output, self.txt_out, method="cctbx"
                        )
                        return True
                    else:
                        return False
                    ...
                    wx.MessageBox(
                        "ERROR: CCTBX.XFEL target file not found!",
                        "ERROR",
                        wx.OK | wx.ICON_ERROR,
                    )
                    return False
                ...
                if self.params.dials.target == None:
                    ...
                    if write_def.ShowModal() == wx.ID_YES:
                        inp.write_defaults(
                            self.params.output, self.txt_out, method="dials"
                        )
                        return True
                    else:
                        return False
                    ...
                    wx.MessageBox(
                        "ERROR: DIALS target file not found!",
                        "ERROR",
                        wx.OK | wx.ICON_ERROR,
                    )
                    return False
