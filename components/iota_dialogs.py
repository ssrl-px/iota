...
class CCTBXOptions(BaseDialog):
    ...
    def __init__(
        ...
        **kwargs
        ...
        options_sizer.Add(self.filter_options, flag=wx.ALL | wx.EXPAND, border=10)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.estimate_gain = wx.CheckBox(
            self.options, label="Estimate gain for each image"
        )
        ...
        self.auto_threshold = wx.CheckBox(
            self.options, label="Estimate threshold for each image"
        )
