...
class MainWindow(wx.Frame):
    def __init__(self, parent, id, title):
        wx.Frame.__init__(
            self, parent, id, title, pos=wx.DefaultPosition, size=(800, 500)
        )
    ...
    def InitUI(self):
        ...
        self.texit = self.toolbar.AddLabelTool(
            wx.ID_EXIT,
            label="Quit",
        ...
        self.tb_btn_stop = self.toolbar.AddLabelTool(
            ...
            shortHelp="Abort",
            longHelp="Abort all running processes",
        )
        self.toolbar.EnableTool(self.tb_btn_run.GetId(), False)
        self.toolbar.EnableTool(self.tb_btn_stop.GetId(), False)
        self.toolbar.AddSeparator()
        self.tb_btn_script = self.toolbar.AddLabelTool(
            wx.ID_ANY,
            label="Output Script",
