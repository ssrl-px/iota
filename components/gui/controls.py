...
class FileListCtrl(CustomListCtrl):
    ...
    def __init__(self, parent, size=(-1, 200)):
        ...
        self.btn_browse = GradButton(
            self, bmp=bmp_browse, label=" Browse...", label_size=norm_font_size
        )
    ...
    def open_file_dialog(self):
        ...
        wildcard = (
            "Image Files (*.cbf; *.mccd; *.img)|*.cbf;*.mccd;*.img|"
    ...
    def onTypeChoice(self, e):
        ...
        for idx in range(self.ctr.GetItemCount()):
            if self.ctr.GetItemData(idx).type_selection != 0:
                data_items += 1
        self.window.set_tool_state(self.window.tb_btn_run, (data_items > 0))
        e.Skip()
