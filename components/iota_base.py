...
class ProcInfo(object):
    ...
    def from_folder(cls, path, **kwargs):
        ...
        if os.path.isdir(obj_base):
            info_dict["finished_objects"] = util.ginp.get_file_list(
                path, ext_only="int"
            )
