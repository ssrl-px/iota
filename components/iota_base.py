...
class ImageImporterBase:
    ...
    def prep_output(self):
        ...
        self.img_object.obj_path = util.make_image_path(
            self.img_object.img_path, self.init.input_base, self.init.obj_base
        )
        ...
        self.img_object.int_path = util.make_image_path(
            self.img_object.img_path, self.init.input_base, self.init.fin_base
        )
        fname = util.make_filename(
            self.img_object.img_path, prefix="int", new_ext="pickle"
        )
        ...
        self.img_object.log_path = util.make_image_path(
            self.img_object.img_path, self.init.input_base, self.init.log_base
        )
        ...
        self.img_object.viz_path = util.make_image_path(
            self.img_object.img_path, self.init.input_base, self.init.viz_base
        )
        fname = util.make_filename(
            self.img_object.img_path, prefix="int", new_ext="png"
        )
...
class ProcessingThreadBase(Thread):
    ...
    def __init__(self, init=None, iterable=None, stage="all"):
        Thread.__init__(self, name="iota_proc")
        self.init = init
        self.iterable = (
            self.init.iterable if hasattr(self.init, "iterable") else iterable
        )
        self.stage = stage
        self.importer = None
...
class ProcessInfo(object):
    ...
    def __init__(self, tmp_base, int_base):
        ...
        # Summary
        self.status_summary = {"nonzero": [], "names": [], "patches": []}
...
class InitBase(object):
    ...
    def make_input_list(self):
        ...
        input_list = self.ginp.make_input_list(
